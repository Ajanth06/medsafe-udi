          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">
                Cross-Exchange Arbitrage Control
              </h1>
              <p className="mt-3 max-w-3xl text-sm text-slate-300/80 md:text-base">
                Fokus auf Cross-Exchange-Arbitrage zwischen mehreren Venues mit
                Bot-Konfiguration, Start- und Stop-Control, Live-Quotes,
                Opportunity-Monitoring, Backtesting und Trade-Historie.
              </p>
            </div>
